    ...
    <div class="col py-3">
        <div class="card shadow">
            <div class="row py-3 text-center">
                <div class="col-md-12">
                    <img src="{{ asset('/storage/images/avatars.png') }}" alt="avatar" class="rounded-circle img-thumbnail"
                        style="width: 100px;">
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input id="middlename" type="text" placeholder="Carlos"
                        ...
                        <div class="col-md-3">
                            ...
                            <input id="studentId" type="text" placeholder="ITE-1900137"
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="civil_status" id="civil_status"
                                class="form-control form-select my-select @error('civil_status') is-invalid @enderror"
                                name="civil_status" value="{{ old('civil_status') }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input id="address" type="text"
                                    placeholder="R.T. Lim Boulevard, Baliwasan, Zamboanga City"
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="major" id="major"
                                class="form-control form-select my-select @error('major') is-invalid @enderror"
                                name="major" value="{{ old('major') }}">
                                <option disabled selected>Choose...</option>
                                <option value="Major in Information Technology">
                                    {{ __('Major in Information Technology') }}</option>
                                <option value="Major in Electronics">{{ __('Major in Food Technology') }}
                                </option>
                                <option value="Major in Civil Technology">
                                    {{ __('Major in Civil Technology') }}</option>
                                <option value="Major in Garments, Fashion and design">
                                    {{ __('Major in Garments, Fashion and design ') }}</option>
                                <option value="Major in Electrical">{{ __('Major in Electrical') }}</option>
                                <option value="Major in Food Production Services">
                                    {{ __('Major in Food Production Services') }}</option>
                                <option value="Major in Hospitality Management">
                                    {{ __('Major in Hospitality Management') }}</option>
                                <option value="Major in Mechanical">{{ __('Major in Mechanical') }}</option>
                                <option value="Major in Automotive">{{ __('Major in Automotive') }}</option>
                            </select>
                            @error('major')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="col-md-2">
                            ...
                            <input id="phone" type="text" placeholder="09557815639"
                        ...
                        <div class="col-md-2">
                            ...
                            <select id="gender" type="text"
                                class="form-control form-select @error('gender') is-invalid @enderror" name="gender"
                        ...
                        <div class="col-md-2">
                            ...
                            <select name="section" id="section"
                                class="form-control form-select my-select @error('section') is-invalid @enderror"
                        ...
                        <div class="col-md-2">
                            ...
                            <select name="semester" id="semester"
                                class="form-control form-select my-select @error('semester') is-invalid @enderror"
                        ...
                        <div class="col-md-2">
                            ...
                            <select name="curriculum_year" id="curriculum_year"
                                class="form-control form-select my-select @error('curriculum_year') is-invalid @enderror"
                                name="curriculum_year" value="{{ old('curriculum_year') }}">
                                <option disabled selected>Choose...</option>
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="student_type" id="student_type"
                                class="form-control form-select my-select @error('student_type') is-invalid @enderror"
                                name="student_type" value="{{ old('student_type') }}">
                                <option disabled selected>Choose...</option>
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="student_status" id="student_type"
                                class="form-control form-select my-select @error('student_status') is-invalid @enderror"
                                name="student_status" value="{{ old('student_status') }}">
                                <option disabled selected>Choose...</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <div class="input-group-text"><i class="fa fa-lock"></i></div>
                                <input id="password-confirm" placeholder="Must same with your password." type="password"
